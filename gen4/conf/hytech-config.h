...
/* #define HYTECH_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (HYTECH_USE_DIAG_MONITORS) and define below
